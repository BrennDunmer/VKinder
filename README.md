...
4. Написать в чат боту слово "предпочтения", что инициализирует основной скрипт по заполнению анкеты и поиску профилей. Поиск занимает достаточно много времени, придется подождать около 2-3 минут