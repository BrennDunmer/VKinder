...
4. Написать в чат боту слово "искать", что инициализирует основной скрипт по поиску профилей на основании информации из аккаунта пользователя. Так же доступно изменение настроек для поиска через команду "предпочтения"